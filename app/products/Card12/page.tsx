      ...
      <div className="relative bg-white p-6 rounded-lg shadow-lg w-full max-w-3xl border border-gray-50">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="text-left">
            <p className="text-lg font-semibold">ชื่อสินค้า: <span className="font-normal">GOD Ene</span></p>
            <p className="text-lg font-semibold mt-2 text-green-600">รายละเอียดสินค้า:</p>
            <p className="mt-1">
              จอมเทพ <strong>GOD Ene</strong> และ <strong>Sabo</strong><br />
              ซึ่งเป็นหมายเลข <strong>2</strong> สุดแกร่งแห่งกองทัพปฏิวัติ!
            </p>
